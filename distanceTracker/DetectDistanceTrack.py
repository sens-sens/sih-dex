                ...
                if confidence > 0.98:
                    ...
                    if width_in_frame != 0:
                        ...
                        if roundDistance <= 110:
                            ...
                            engineStatus = "START"
                    # label = "{}: {:.2f}% -- Distance: {:.2f}cm".format(classes[idx], confidence * 100, roundDistance)
                    # print("\n Enginer Status: " + engineStatus + " Turn: " + turn + "", startXTurn, " ", endXTurn)
                    # label1 = "Engine Status: {} -- Turn: {}",engineStatus, turn
                    # tracking the person
                    tracker_type = 'KCF'
                    ...
                    while True:
                        ...
                        cv2.putText(frame, "Distance : " + roundDistance + "cm", (100, 50), cv2.FONT_HERSHEY_SIMPLEX,
                                    0.75, (50, 170, 50), 2)
                        cv2.putText(frame, "Engine Status : " + engineStatus, (100, 50), cv2.FONT_HERSHEY_SIMPLEX,
                                    0.75, (50, 170, 50), 2)
                    ...
                    # cv2.putText(frame, label1, (startX, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, bbox_colors[idx], 2)
