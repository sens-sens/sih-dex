...
if __name__ == "__main__":
    # creating processes
    tracking_ps = multiprocessing.Process(target=tracking(), args=[])
    detect_distance_ps = multiprocessing.Process(target=detect_distance(), args=[])


    # starting processes
    tracking_ps.start()
    detect_distance_ps.start()


    # wait until thread 1 is completely executed
    detect_distance_ps.join()
